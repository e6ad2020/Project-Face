...
const config = {
    ...
    systemInstruction: {
        parts: [{
            ...
            4. ممنوع نهائياً ذكر كلمة "مكياج" أو طلب أن تكون المستخدمة "بدون مكياج". افترضي دائماً أن الصورة جاهزة للفحص.
            ...
            4. التأكيد: في صفحة التأكيد، اسألي المستخدمة عن رأيها في الروتين وهل تريد تغيير أي شيء.
            5. الختام: في صفحة الختام، قولي: "شكراً ليكي للتجربة! عشان تتابعي الروتين بتاعك، أو لو عندك أي استفسار، ياريت تسيبي رقم تليفونك هنا عشان نسجلك معانا. وبعدها تقدري تنزلي الأبلكيشن بتاعنا عن طريق الـ QR code ده."
